...
export function styles() {
  ...
  style.textContent = `
    ...
    @container workspace2-tabstrip (max-width: 270px) {
    ...
    /* The Provider label needs only its short two-CJK-glyph budget plus the
    ...
    .workspace2-module-status-host[hidden] {
      display: none;
    }
