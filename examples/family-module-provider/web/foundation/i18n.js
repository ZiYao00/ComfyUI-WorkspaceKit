// Minimal locale loader adapted from ComfyUI-WorkspaceKit/entry/core/i18n.js
// (MIT License). Generic: safe to copy into a new family-module plugin.
...
export function t(key, values = {}) {
  ...
  if (template === key && !missingKeys.has(key)) {
    missingKeys.add(key);
    // CHANGE ME: rename this log prefix to your plugin.
    console.warn(`[WorkspaceKit Example] Missing translation key: ${key}`);
  }
